    ...
    def predict(self):
        ...
        if self.exported:
            if self.post_process=='watershed':
                csv_path = self.saved_dir / 'init_results' / 'init_results_ws.csv'
                output_dir = self.saved_dir / 'init_results' / 'init_prediction_ws'
            elif self.post_process=='randomwalk':
                csv_path = self.saved_dir / 'init_results' / 'init_results_rw.csv'
                output_dir = self.saved_dir / 'init_results' / 'init_prediction_rw'

...
class ResNet(BaseNet):
    ...
    def __init__(self, in_channels, block, layers, strides=(2, 2, 2, 2), dilations=(1, 1, 1, 1)):
        self.inplanes = 64
...
def ResNet50(in_channels, pretrained=True, **kwargs):

    model = ResNet(in_channels, _Bottleneck, [3, 4, 6, 3], **kwargs)
    if pretrained:
